...
class FlaskTestRoutes(unittest.TestCase):
	...
	def test_accept_invitation(self):
		...
		notification_exists = db.session.query(Notification).filter(Notification.event_id == 1, Notification.receiver_id == 1, Notification.type == NotificationType.invite_accepted).first()
