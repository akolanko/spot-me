...
def get_notifications(user_id):
	...
	pending_received, pending_sent = have_pending_requests(user_id)
	total_pending_received = len(received_friend_requests)
	...
	return {'received_friend_requests': received_friend_requests, 'sent_friend_requests': sent_friend_requests, 'pending_received': pending_received, 'pending_sent': pending_sent, 'total_pending_received': total_pending_received, 'recent_conversation': recent_conversation, 'unread_msgs_count': unread_msgs_count, 'unread_conversations': unread_conversations, 'ntfs_count': ntfs_count, 'notifications': notifications}
